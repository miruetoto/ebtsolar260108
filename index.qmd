...
:::: {.columns}
::: {.column width="60%"}
![서울 지역 태양복사량 시계열](figs/fig1.png){width="100%"}
:::
::: {.column width="40%"}
**이중 구조의 공존**
...
:::: {.columns}
::: {.column width="60%"}
![다지역 태양복사량 비교](figs/fig2.png){width="100%"}
:::
::: {.column width="40%"}
...
:::: {.columns}
::: {.column width="60%"}
![거리는 비슷하지만 패턴은 다른 두 쌍](figs/fig3.png){width="100%"}
:::
::: {.column width="40%"}
**비교: 두 지역 쌍**
...
:::: {.columns}
::: {.column width="50%"}
![전국 태양복사량 상관행렬](figs/fig4.png){width="90%"}
:::
::: {.column width="50%"}
**문제점**
...
:::: {.columns}
::: {.column width="50%"}
![서울-흑산도 vs 고창-영광군](figs/fig5.png){width="100%"}
:::
::: {.column width="50%"}
| 지역 쌍 | 상관계수 | 실제 패턴 |
|---------|----------|-----------|
...
:::: {.columns}
::: {.column width="60%"}
![일사량 차이 히스토그램](figs/fig6.png){width="100%"}
:::
::: {.column width="40%"}
- 차이값이 0에 집중 → 유사해 보임
- **원인**: 밤 시간대에 둘 다 0
...
![EBT 분해 과정 시각화](figs/sec32_fig1.png){width="100%"}
...
![분해 후 상관구조 비교](figs/corr_grid_plot_v3.png){width="100%"}
...
![제안 프레임워크: EBT 분해 → 이중 그래프 구성 → STGNN 학습 → 재결합](pipeline.png){width="85%"}
...
![태풍 영향 상위 9개 지역](figs/251121_top9_typhoon_map_timeseries_geojson.png){width="100%"}
...
![Raw scale 분해 비교 (서울, 2022-09-01 ~ 09-15)](figs/A1_fig1.png){width="90%"}
...
![Log scale 분해 비교 (서울, 2022-09-01 ~ 09-15)](figs/A1_fig2.png){width="90%"}
